			...
			<?php while ( have_posts() ) : the_post(); ?>
				...
				<div class="question">
					...
					<div class="question-summary">
						...
						<?php the_excerpt(); ?>
						<?php the_question_tags( '<p class="question-tags">Tags: ', ' ', '</p>' ); ?>
						<p class="question-started">Asked on <?php the_qa_time( get_the_ID() ); ?> by <?php the_qa_user_link( $post->post_author ); ?></p>
